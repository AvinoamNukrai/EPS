...
public class TreeGenerator {
     ...
     * The method calc the exact starting coordinates of each tree by the given callback and starts build upon.
     */
    public Vector2 createTrunk(int xTrunkLeft) {
        ...
        for (int i = 1; i < trunkHeight / Block.SIZE - 1; i++) {
            for (int j = 0; j < TRUNK_WIDTH_DIMENSION / Block.SIZE; j++) {
                ...
                Renderable blockRectangle = new RectangleRenderable(ColorSupplier.approximateColor(TRUNK_COLOR));
     ...
     * The method calc the range and coordinates of the top tree by the given input and builds blocks (Leaf) upon.
     */
