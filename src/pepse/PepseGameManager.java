...
public class PepseGameManager extends GameManager {
    ...
    private void createAvatar(UserInputListener inputListener, ImageReader imageReader) {
        float xCoordAvatarTopLeftCorner = windowDimensions.x() * 1 / 2f - Avatar.AVATAR_SIZE * 1 / 2f;
        ...
        setCamera(new Camera(avatar, windowDimensions.mult(1 / 2f).subtract(avatar.getCenter()),
    ...
    private void updateAvatarLocation() {
        ...
        if (avatar.getTopLeftCorner().y() > terrain.groundHeightAt(xCoordAvatarTopLeftCorner) + 1 / 2f * Block.SIZE) {
